...
MOCK_MODULES = ['ants','numpy','nibabel','sklearn','sklearn.ensemble','sklearn.externals','sklearn.preprocessing',
...
latex_documents = [
    (master_doc, 'synthit.tex', 'synthit Documentation',
...
man_pages = [
    (master_doc, 'synthit', 'synthit Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'synthit', 'synthit Documentation',
     author, 'synthit', 'One line description of project.',
     'Miscellaneous'),
]
